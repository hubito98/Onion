...
test_data['rm'] = (test_data['rm'] - data_stats['min']['rm']) / (data_stats['max']['rm'] - data_stats['min']['rm'])
test_data['lstat'] = (test_data['lstat'] - data_stats['min']['lstat']) / (data_stats['max']['lstat'] - data_stats['min']['lstat'])
test_data['crim'] = (test_data['crim'] - data_stats['min']['crim']) / (data_stats['max']['crim'] - data_stats['min']['crim'])
test_data['zn'] = (test_data['zn'] - data_stats['min']['zn']) / (data_stats['max']['zn'] - data_stats['min']['zn'])
test_data['indus'] = (test_data['indus'] - data_stats['min']['indus']) / (data_stats['max']['indus'] - data_stats['min']['indus'])
test_data['chas'] = (test_data['chas'] - data_stats['min']['chas']) / (data_stats['max']['chas'] - data_stats['min']['chas'])
test_data['nox'] = (test_data['nox'] - data_stats['min']['nox']) / (data_stats['max']['nox'] - data_stats['min']['nox'])
test_data['age'] = (test_data['age'] - data_stats['min']['age']) / (data_stats['max']['age'] - data_stats['min']['age'])
test_data['dis'] = (test_data['dis'] - data_stats['min']['dis']) / (data_stats['max']['dis'] - data_stats['min']['dis'])
test_data['rad'] = (test_data['rad'] - data_stats['min']['rad']) / (data_stats['max']['rad'] - data_stats['min']['rad'])
test_data['tax'] = (test_data['tax'] - data_stats['min']['tax']) / (data_stats['max']['tax'] - data_stats['min']['tax'])
test_data['ptratio'] = (test_data['ptratio'] - data_stats['min']['ptratio']) / (data_stats['max']['ptratio'] - data_stats['min']['ptratio'])
test_data['black'] = (test_data['black'] - data_stats['min']['black']) / (data_stats['max']['black'] - data_stats['min']['black'])
